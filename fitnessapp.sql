...
INSERT INTO `favourites` VALUES (4,7,31,'2026-04-04 07:07:15'),(5,7,29,'2026-04-04 07:07:26'),(6,7,40,'2026-04-04 07:24:54'),(7,7,32,'2026-04-04 07:25:12'),(8,1,21,'2026-04-04 08:04:58'),(9,1,20,'2026-04-04 08:05:15'),(10,4,11,'2026-04-04 09:18:43'),(11,3,10,'2026-04-06 08:39:23'),(12,13,25,'2026-04-06 10:32:33'),(13,9,6,'2026-04-08 19:10:51'),(14,22,1,'2026-04-11 18:21:31');
...
CREATE TABLE `nutrition_goals` (
  ...
  CONSTRAINT `nutrition_goals_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nutrition_goals` VALUES (1,22,2000,150,250,65,'2026-04-14 08:07:13'),(2,7,5000,300,249,65,'2026-04-15 19:07:25'),(3,2,2500,150,250,65,'2026-04-24 15:14:22');
...
INSERT INTO `nutrition_logs` VALUES (1,22,'Maxi Cheese Burger',256.0,13.0,20.0,13.0,'2026-04-14 08:06:47'),(2,22,'Oregano Crostini Italian Bread Bites',467.0,10.0,67.0,17.0,'2026-04-14 08:08:25'),(4,7,'Gerble - Organic Chocolate Cookie Flavored w/ Banana, 132g (4.7oz)',459.0,9.0,59.0,19.0,'2026-04-15 19:04:39');
...
INSERT INTO `workout_logs` VALUES (1,22,2,1,8,5.00,'2026-04-11 18:13:05');
...
-- Dump completed on 2026-05-06 11:25:25
